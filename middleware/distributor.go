...
func getModelRequest(c *gin.Context) (*ModelRequest, bool, error) {
    ...
    if strings.HasPrefix(c.Request.URL.Path, "/v1/audio") || strings.HasPrefix(c.Request.URL.Path, "/v1/t2a_v2") {
        relayMode := relayconstant.RelayModeAudioSpeech
        if strings.HasPrefix(c.Request.URL.Path, "/v1/audio/speech") || strings.HasPrefix(c.Request.URL.Path, "/v1/t2a_v2") {
