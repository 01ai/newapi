            ...
            properties:
              model:
                allOf:
                  - type: string
                    description: >-
                      请求的模型版本，可选范围：`speech-2.6-hd`, `speech-2.6-turbo`,
              ...
              aigc_watermark:
                allOf:
                  - type: boolean
                    ...
                    default: false
            required: true
            refIdentifier: '#/components/schemas/T2aV2Req'
            requiredProperties:
              - model
              - text
        examples:
                  ...
                  - &ref_3
                    ...
                    properties:
                      ...
                      status_msg:
                        type: string
                        description: 状态详情
            refIdentifier: '#/components/schemas/T2aV2Resp'
        examples:
          非流式:
            value:
              data:
      ...
      properties:
        voice_id:
          ...
          description: >-
            ...
            [系统音色列表](/docs/faq/system-voice-id)，也可使用 [查询可用音色
            API](/docs/api-reference/speech-t2a-async-query) 查询系统支持的全部音色
        weight:
          type: integer
          format: int64
          description: >-
